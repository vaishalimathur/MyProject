...
public class DefaultCheckboxconfiguratortemplateservicesService implements CheckboxconfiguratortemplateservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCheckboxconfiguratortemplateservicesService.class);
	...
	{
		return DefaultCheckboxconfiguratortemplateservicesService.class.getResourceAsStream("/checkboxconfiguratortemplateservices/sap-hybris-platform.png");
	}
